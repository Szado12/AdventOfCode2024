...
//     private List<(string wire1, string wire2, string output, Func<string, string, int> operation)> _tasks = new();
//     
//     public string Solve()
//     {
...
//                 if (readTasks)
//                 {
//                     _tasks.Add((parameters[0], parameters[2], parameters[4], SelectOperation(parameters[1])));
//                     continue;
//                 }
//
//                 var wire = parameters[0].Substring(0, 3);
//                 var value = Int32.Parse(parameters[1]);
//                 _wires[wire] = value;
//             }
//         }
//
//         var tasksToProcess = _tasks;
...
//             }
//
//             tasksToProcess = tasksNotPossibleToProcess;
//         }
//
//         long output = 0;
